...
class DenseNet(tf.keras.Model):
    ...
    def __init__(self, num_init_features, growth_rate, block_layers, compression_rate, drop_rate):
        ...
        # 全连接层，进行4分类
        self.fc = layers.Dense(units=5, activation=tf.keras.activations.softmax)
...
def densenet():
    model= DenseNet(num_init_features=64, growth_rate=32, block_layers=[2,2,2,2], compression_rate=0.5, drop_rate=0.5)
    # savePath = '../training'
    # saveFile = os.path.join(savePath, 'train0.ckpt')
